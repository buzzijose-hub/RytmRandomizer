...
def _accepted_sl_result():
    metadata = PAD3_COMMANDS["SL"]
    label = metadata["label"]
    lane_action = "load_pad3_sy_raw_lp1_bassline_mode"
    ...
    result_metadata = {
        ...
        "target_pad": metadata["pad"],
        "lane": "pad_3_sy_raw_lane",
        "behavior_family": "pad3-lane/sy-raw-lp1-bassline-mode",
        "lane_action": lane_action,
    ...
    return Pad3LaneBehaviorResult(
        ...
        behavior_family="pad3-lane/sy-raw-lp1-bassline-mode",
        accepted=True,
        reason="supported_pad3_sy_raw_lp1_bassline_mode_intent",
        target_pad=3,
        lane="Pad 3 SY Raw lane",
        lane_action=lane_action,
        intent_kind="mode_load",
...
def _accepted_sx_result():
    metadata = PAD3_COMMANDS["SX"]
    label = metadata["label"]
    lane_action = "load_pad3_sy_raw_sci_fi_motion_accent_mode"
    ...
    result_metadata = {
        ...
        "target_pad": metadata["pad"],
        "lane": "pad_3_sy_raw_lane",
        "behavior_family": "pad3-lane/sy-raw-sci-fi-motion-accent-mode",
        "lane_action": lane_action,
        "intent_kind": "mode_load",
        "mode_concept": mode_concept,
        "mock_only": True,
    ...
    return Pad3LaneBehaviorResult(
        ...
        behavior_family="pad3-lane/sy-raw-sci-fi-motion-accent-mode",
        accepted=True,
        reason="supported_pad3_sy_raw_sci_fi_motion_accent_mode_intent",
        target_pad=3,
        lane="Pad 3 SY Raw lane",
        lane_action=lane_action,
        intent_kind="mode_load",
