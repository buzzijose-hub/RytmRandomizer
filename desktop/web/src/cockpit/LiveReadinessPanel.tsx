...
export const DEFAULT_LIVE_READINESS_MODEL: LiveReadinessModel = {
  pad_surface: {
    ...
    cards_by_pad: cardsByPad([
      ...
      pad(5, 'BT', 'BT Rim', 'planned_expansion', false, 'tom', 'BT Rim', 3, 0, 3, ['BT Rim']),
      pad(6, 'LT', 'LT Low', 'planned_expansion', false, 'tom', 'LT Low', 3, 0, 3, ['LT Low']),
      pad(7, 'MT', 'MT Mid', 'planned_expansion', false, 'tom', 'MT Mid', 3, 0, 3, ['MT Mid']),
      pad(8, 'HT', 'HT High', 'planned_expansion', false, 'tom', 'HT High', 3, 0, 3, ['HT High']),
      pad(9, 'CP', 'CP Clap', 'planned_expansion', false, 'perc', 'CP Clap', 4, 0, 4, ['CP Clap']),
      pad(10, 'RS', 'RS Riser', 'planned_expansion', false, 'fx', 'RS Riser', 4, 0, 4, ['RS Riser']),
      pad(11, 'SY', 'SY Raw', 'planned_expansion', false, 'synth', 'SY Raw', 4, 0, 4, ['SY Raw']),
      pad(12, 'BD', 'BD Acoustic', 'planned_expansion', false, 'kick', 'BD Acoustic', 3, 0, 3, [
        'BD Acoustic',
      ]),
    ]),
  ...
  snapshot_compatibility: {
    ...
    pads: [
      ...
      compatibilityPad(5, 'BT', 'BT Rim', 'planned', 'limited', false, 3, 0, 3, 'awaiting V1.34-compatible mutation routing'),
      compatibilityPad(6, 'LT', 'LT Low', 'planned', 'limited', false, 3, 0, 3, 'awaiting V1.34-compatible mutation routing'),
      compatibilityPad(7, 'MT', 'MT Mid', 'planned', 'limited', false, 3, 0, 3, 'awaiting V1.34-compatible mutation routing'),
      compatibilityPad(8, 'HT', 'HT High', 'planned', 'limited', false, 3, 0, 3, 'awaiting V1.34-compatible mutation routing'),
      compatibilityPad(9, 'CP', 'CP Clap', 'planned', 'limited', false, 4, 0, 4, 'awaiting V1.34-compatible mutation routing'),
      compatibilityPad(10, 'RS', 'RS Riser', 'planned', 'limited', false, 4, 0, 4, 'awaiting V1.34-compatible mutation routing'),
      compatibilityPad(11, 'SY', 'SY Raw', 'planned', 'limited', false, 4, 0, 4, 'awaiting V1.34-compatible mutation routing'),
      compatibilityPad(12, 'BD', 'BD Acoustic', 'planned', 'limited', false, 3, 0, 3, 'awaiting V1.34-compatible mutation routing'),
    ],
