...
| ---------------------------------------------------------------------------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| **Any Python invocation** (pytest, pip, scripts) — **consult FIRST**         | `python-on-windows`                | The Windows Store ships `python.exe` shims that crash from non-interactive subprocesses ("specified disk or diskette cannot be accessed"). Use the absolute interpreter path or a venv. See `.claude/skills/python-on-windows/SKILL.md`. |
