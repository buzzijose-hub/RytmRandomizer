...
python -m rytm_randomizer.cli style-performance-arc-reference-match-report --description "Jeff Mills Oscar Mulero Birmingham pressure" --rytm "G:\ANALOG RYTM\KITS\ANALOGRYTMKITS2.syx" --analog-four "G:\ANALOG FOUR\KITS\ANALOGFOURKITS1.syx" --events --limit 8   # reference-match nonblank text/audio/library influence evidence to a curated performance arc, cue sheet, and passive snapshot preview
