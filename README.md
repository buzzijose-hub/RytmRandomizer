...
plan, and mock-apply it (`mock_apply_operator_package`). These review acks prove
no MIDI port opened, no MIDI was sent, no file was written, no snapshot mutated,
no send plan applied, and no event stream emitted.
