...
_CODEX_HANDOFF = (
    ...
    "code review by walking the 8-step procedure in "
    ".claude/skills/code-review/SKILL.md against the pushed commits "
    "(`git diff modularize-v1.34...HEAD`). Do NOT skip Step 7 (abstraction "
    "reuse / genericization: could the new code be generalized, or does an "
    ...
    "metrics, or the report formatter already cover it) or Step 8 "
    "(architecture-doc + diagram freshness: are docs/ARCHITECTURE.md and "
    "docs/ARCHITECTURE_DIAGRAMS.md updated for any architecture-surface "
    "change, and do the counts the docs quote still match). Produce the "
    "structured Critical/Important/Minor/Abstraction/Docs verdict and post "
    "it as a PR comment."
)
