...
_GRANDFATHERED_BARE_CONSTANTS: Final[frozenset[str]] = frozenset(
    {
        ...
        "rytm_randomizer/cockpit/engine/send_plan.py:_DEFAULT_MIDI_CHANNEL",
        ...
        "rytm_randomizer/project_status_report.py:CLOSEOUT_STATUS",
        "rytm_randomizer/project_status_report.py:COLLABORATOR_REVIEW_INTAKE_STATUS",
        "rytm_randomizer/project_status_report.py:COLLABORATOR_REVIEW_TRIAGE_TEMPLATE_STATUS",
        "rytm_randomizer/project_status_report.py:CONVERGENCE_STATUS",
        "rytm_randomizer/project_status_report.py:PASSIVE_CLI_COMMANDS",
        "rytm_randomizer/project_status_report.py:PROJECT_PHASE",
        ...
        "rytm_randomizer/reports/__init__.py:ACTIVE_BOUNDARY_CLOSEOUT_COVERAGE",
        "rytm_randomizer/reports/__init__.py:ACTIVE_BOUNDARY_SAFETY",
        "rytm_randomizer/reports/__init__.py:ANCHOR_PROFILE_CLOSEOUT_COVERAGE",
        "rytm_randomizer/reports/__init__.py:ANCHOR_PROFILE_PARKED_SECTIONS",
        "rytm_randomizer/reports/__init__.py:ANCHOR_PROFILE_REPORT_TITLE",
        "rytm_randomizer/reports/__init__.py:ANCHOR_PROFILE_SAFETY",
        "rytm_randomizer/reports/__init__.py:BRIDGE_SUMMARY",
        "rytm_randomizer/reports/__init__.py:MOCK_MAPPER_BOUNDARY",
        "rytm_randomizer/reports/__init__.py:PARITY_ABSENT_BEHAVIOR",
        "rytm_randomizer/reports/__init__.py:PARITY_CLOSEOUT_COVERAGE",
        "rytm_randomizer/reports/__init__.py:PARITY_PARKED_SCOPE",
        "rytm_randomizer/reports/__init__.py:PARITY_PROTECTED_FILE_STATE",
        "rytm_randomizer/reports/__init__.py:PARITY_REPORT_BOUNDARY",
        "rytm_randomizer/reports/__init__.py:PARKED_CASES",
        "rytm_randomizer/reports/__init__.py:PARKED_REPORT_INPUTS",
        "rytm_randomizer/reports/__init__.py:REJECTED_CASES",
        "rytm_randomizer/reports/__init__.py:REPORT_MODE",
        "rytm_randomizer/reports/__init__.py:REQUIRED_CONDITIONS",
        "rytm_randomizer/reports/__init__.py:RESULT_METADATA_FIELDS",
        "rytm_randomizer/reports/__init__.py:RUNTIME_ADJACENT_MOCK_ONLY_SAFE_FAILURES",
        "rytm_randomizer/reports/__init__.py:RUNTIME_PLAN_REPORT_BOUNDARY",
        "rytm_randomizer/reports/__init__.py:SAFETY_BOUNDARIES",
        "rytm_randomizer/reports/__init__.py:SAFETY_BOUNDARY",
        "rytm_randomizer/reports/__init__.py:SAFE_FAILURE_SUMMARY",
        "rytm_randomizer/reports/__init__.py:SUPPORTED_REPORT_INPUTS",
        "rytm_randomizer/reports/__init__.py:UNSUPPORTED_ACTIVE_BOUNDARY_PROFILE_KEYS",
        "rytm_randomizer/reports/__init__.py:UNSUPPORTED_REPORT_INPUTS",
        "rytm_randomizer/reports/__init__.py:UNSUPPORTED_SAFE_GROUP_PROFILE_KEYS",
        "rytm_randomizer/reports/__init__.py:UNSUPPORTED_SCOPE",
        "rytm_randomizer/reports/__init__.py:UNSUPPORTED_SOURCE_KINDS",
