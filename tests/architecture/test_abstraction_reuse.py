...
_GRANDFATHERED_DUPLICATE_NAMES: Final[frozenset[tuple[str, ...]]] = frozenset(
    {
        ...
        (
            ...
            "rytm_randomizer/reports/live_gui_overlay/render_tree.py",
        ),
        (
            "func",
            "_binding_json",
        ...
        (
            ...
            "rytm_randomizer/reports/live_gui_overlay/render_tree.py",
            "rytm_randomizer/reports/live_gui_overlay/screen_contract.py",
            "rytm_randomizer/reports/live_gui_playback_transcript.py",
        ...
        (
            "func",
            "_body_lines",
            "rytm_randomizer/reports/a4_soft_capture.py",
            ...
            "rytm_randomizer/reports/analog_four_style_snapshot_routing.py",
            "rytm_randomizer/reports/analog_rytm_midi_catalog.py",
            ...
            "rytm_randomizer/reports/dual_machine_style_selection_mock_preview.py",
            "rytm_randomizer/reports/dual_machine_style_snapshot_routing.py",
            "rytm_randomizer/reports/rytm_cc_observe.py",
        ...
        # PR #104 merged before this Gate 17 ratchet branch was
        # refreshed; these send-plan rehearsal helper duplicates
        # are now base-line debt for the grandfather floor.
        (
            "func",
            "_action_control_json",
            "rytm_randomizer/reports/cockpit_export_rehearsal.py",
            "rytm_randomizer/reports/cockpit_send_plan_rehearsal_surface.py",
        ),
        (
            "func",
            "_action_control_lines",
            "rytm_randomizer/reports/cockpit_export_rehearsal.py",
            "rytm_randomizer/reports/cockpit_send_plan_rehearsal_surface.py",
        ),
        (
        ...
        (
            "func",
            "_send_plan_from_file",
            "rytm_randomizer/reports/cockpit_send_plan_operator_readiness.py",
            "rytm_randomizer/reports/cockpit_send_plan_rehearsal_surface.py",
        ),
        (
            "func",
            "_send_plan_from_json",
            "rytm_randomizer/reports/cockpit_send_plan_operator_readiness.py",
            "rytm_randomizer/reports/cockpit_send_plan_rehearsal_surface.py",
        ),
        (
