...
_HAND_ROLLED_OPTION_LOOPS: Final[frozenset[str]] = frozenset(
    {
        ...
        "controller_brain_live_desktop_app_plan.py",
        "controller_brain_live_desktop_component_contract.py",
        "controller_brain_live_desktop_render_contract.py",
        "controller_brain_live_desktop_view_model.py",
        ...
        "live_gui_cockpit_boundary_readiness.py",
        "live_gui_common.py",
        "live_gui_controller_state.py",
        "live_gui_desktop_app_plan.py",
        "live_gui_desktop_blueprint.py",
        "live_gui_desktop_component_contract.py",
        "live_gui_desktop_render_contract.py",
        "live_gui_desktop_render_harness.py",
        "live_gui_desktop_view_model.py",
        "live_gui_implementation_bridge.py",
        "live_gui_interaction_script.py",
        "live_gui_playback_transcript.py",
        "live_gui_playback_validation.py",
        "live_gui_rehearsal_session.py",
        "live_gui_render_tree.py",
        "live_gui_screen_contract.py",
        "live_gui_sidecar_session.py",
        "live_gui_test_harness_contract.py",
        "live_gui_test_harness_readiness.py",
