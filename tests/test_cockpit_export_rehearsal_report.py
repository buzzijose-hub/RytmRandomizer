...
# Note (post-Phase-3 integration): the WS-D rehearsal report originally
# forbade importing cockpit.export.signing / verifier / writer / cli at
# rehearsal-import time. After Phase 3 those modules became sibling
# re-exports of cockpit.export.__init__ that the rehearsal report
# legitimately consumes (e.g. pack_profile_model from the package root).
# The MIDI / sidecar invariant — the actual safety bound — stays in
# FORBIDDEN_REAL_MIDI_AND_ADAPTER_MODULES above.
FORBIDDEN_EXPORT_SIDE_EFFECT_MODULES: tuple[str, ...] = ()
