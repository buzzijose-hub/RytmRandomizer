...
def test_cockpit_command_types_includes_wizard_commands() -> None:
    ...
    # 24 cockpit-native commands + 8 wizard commands = 32 total
    assert len(protocol.COMMAND_TYPES) == 24 + 8
...
def test_cockpit_event_types_includes_wizard_events() -> None:
    ...
    # 10 cockpit-native events + 3 wizard events = 13 total
    assert len(protocol.EVENT_TYPES) == 10 + 3
