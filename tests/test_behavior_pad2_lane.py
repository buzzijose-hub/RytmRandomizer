...
def test_importing_behavior_pad2_lane_prints_nothing():
    code = "import rytm_randomizer.behavior_pad2_lane"
...
def test_deferred_packet_6_pad2_lane_keys_fail_safely():
    ...
    for command_key in ("P2M", "P2H", "P2C", "P2F", "P2T", "P2P", "P2G", "P2R", "P2X", "P2Z"):
...
def test_no_real_midi_library_is_imported():
    import rytm_randomizer.behavior_pad2_lane  # noqa: F401
...
def test_behavior_pad2_lane_exposes_no_active_behavior_names():
    import rytm_randomizer.behavior_pad2_lane as behavior_pad2_lane
