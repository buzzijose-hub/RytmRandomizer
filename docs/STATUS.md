...
- 2026-05-19: added a passive dual-machine kit-bank readiness report.
  ...
  now prints the next passive validation commands for lane checks,
  mapping-session rehearsal, and A4 manifest review before any armed send.
  This is read-only and does not request dumps, receive live SysEx, send MIDI,
  open ports, write SysEx, or touch hardware.
