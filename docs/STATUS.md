...
- 2026-06-14: Cockpit operator set-planning follow-up started after PR #178
  ...
  move as up next, records local stage/promote/skip/clear/dry-run/journal
  activity in an in-memory operator log, and keeps the local set-plan summary
  tied to current plus queued state. This remains frontend/component-local only:
