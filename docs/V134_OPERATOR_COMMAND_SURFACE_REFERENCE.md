...
Use this captured surface as the reference when comparing the V1.34 operator
command vocabulary against the modular package's passive command/scene/profile
metadata (`rytm_randomizer/commands.py`, `scenes.py`, `profiles.py`).
