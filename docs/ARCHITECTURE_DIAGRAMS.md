...
- Current package: `rytm_randomizer/` - 26 top-level Python files + 13 subpackages = 310 total Python modules. The 13 subpackages: `behavior/`, `cockpit/`, `data/`, `devices/` (with nested `devices/strategies/`), `dual_machine/`, `engines/`, `guardrails/`, `observability/`, `reports/`, `senders/`, `snapshot/`, `state/`, `style_analysis/`.
...
flowchart TB
    ...
    Package["Modular package<br/>rytm_randomizer/<br/>(13 subpackages, 310 modules)"]
