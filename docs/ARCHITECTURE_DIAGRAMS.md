...
- Current package: `rytm_randomizer/` - 26 top-level Python files + 14 subpackages = 368 total Python modules. The 14 subpackages: `behavior/`, `cockpit/`, `data/`, `devices/` (with nested `devices/strategies/`), `dual_machine/`, `engines/`, `guardrails/`, `local_ai/`, `observability/`, `reports/`, `senders/`, `snapshot/`, `state/`, `style_analysis/`.
...
flowchart TB
    ...
    Package["Modular package<br/>rytm_randomizer/<br/>(14 subpackages, 368 modules)"]
