...
| Style analysis | `rytm_randomizer/style_analysis/{extractor,feature_report,library,blueprint,analog_four_patch_genome,analog_four_patch_learning,analog_four_patch_corpus,analog_four_patch_send_plan,analog_four_patch_codesigner}.py` |
...
flowchart TB
    ...
    Package["Modular package<br/>rytm_randomizer/<br/>(14 subpackages, 332 modules)"]
...
flowchart TB
    ...
    subgraph ReportsPkg["reports/ subpackage<br/>(was reports.py)"]
        ...
        ROllamaLocalCopilot["ollama_local_copilot.py<br/>passive local-AI packets<br/>+ registered CliCommand"]
    end

    subgraph LocalAiPkg["local_ai/ subpackage"]
        LAProvider["provider.py<br/>DTOs + validation helpers"]
        LAOllama["ollama.py<br/>explicit local HTTP adapter"]
...
flowchart LR
    ...
    subgraph ReportCmds["Direct read-only report commands"]
        ...
        OllamaLocalCopilotReport["ollama-local-copilot-report<br/>passive local-AI packets; --ask-ollama explicit"]
...
flowchart LR
    ...
    subgraph Reports["Passive reports"]
        ...
        OllamaLocalCopilot["ollama-local-copilot-report --question Q [--workflow docs|mutation|patch|all] [--ask-ollama] [--json]"]
    ...
    CliRegistry -->|"registered passive command:<br/>ollama-local-copilot-report"| CLI
