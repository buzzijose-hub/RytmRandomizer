...
| Coupling | 3 | Add one contained strict Rytm codec over the existing layout and Elektron envelope. |
...
| Versioning | 5 | Preserve the frozen V1.34 runtime and existing envelope/layout contracts. |
