...
- [ ] After PR #94 and the local analyzer overlay checkpoint land, rebase or recreate from `origin/modularize-v1.34`, rerun all gates, exact-stage only intended files, push, open a non-stacked PR, request review, and link this plan in the PR body.
