# V1.34 Behavior Parity Next Packet 7 Command Selection Checkpoint After Packet 7E Review
...
This review accepts `SW` as the next docs-only Packet 7F planning branch while
...
- next Packet 7 command selection after Packet 7E created and now being
  reviewed
...
The next Packet 7 command selection checkpoint after Packet 7E is accepted:
...
## 5. Accepted Future Packet 7F Planning Scope

Accepted future Packet 7F planning scope:
...
- create a docs-only Packet 7F Pad 3 lane behavior plan for `SW` only
